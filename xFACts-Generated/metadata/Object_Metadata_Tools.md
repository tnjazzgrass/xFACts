...
Generated: 2026-07-22 10:03:29

## AccessConfig (Table)

### category #0  [metadata_id: 3960]

Operations

### data_flow #0  [metadata_id: 3961]
...
### description #0  [metadata_id: 3958]
...
### design_note #1  [metadata_id: 3962]
...
### design_note #2  [metadata_id: 3963]
...
### module #0  [metadata_id: 3959]

Tools

### query #1  [metadata_id: 3975]
...
### relationship_note #1  [metadata_id: 3964]
...
### relationship_note #2  [metadata_id: 3965]
...
### relationship_note #3  [metadata_id: 4040]
...
### description / config_id #1  [metadata_id: 3966]

Identity primary key.

### description / created_by #7  [metadata_id: 3972]

Who created the access grant.

### description / created_dttm #6  [metadata_id: 3971]

When the access grant was created.

### description / department_scope #4  [metadata_id: 3969]
...
### description / is_active #5  [metadata_id: 3970]

Whether this access grant is active. 0 = disabled, 1 = enabled (default).

### description / item_key #3  [metadata_id: 3968]
...
### description / modified_by #9  [metadata_id: 3974]

Who last modified the access grant.

### description / modified_dttm #8  [metadata_id: 3973]

When the access grant was last modified.

### description / tool_type #2  [metadata_id: 3967]
...
### category #0  [metadata_id: 4028]

Operations

### data_flow #0  [metadata_id: 4029]
...
### description #0  [metadata_id: 4026]
...
### module #0  [metadata_id: 4027]

Tools

### relationship_note #1  [metadata_id: 4038]
Title: AccessConfig
...
### relationship_note #2  [metadata_id: 4039]
...
### description / config_id #2  [metadata_id: 4031]

FK to Tools.AccessConfig. Identifies the parent entity-level access grant this field whitelist belongs to.

### description / created_by #6  [metadata_id: 4035]

Who created the field grant.

### description / created_dttm #5  [metadata_id: 4034]

When the field grant was created.

### description / element_name #3  [metadata_id: 4032]

BDL element name being granted. Matches Catalog_BDLElementRegistry.element_name.

### description / field_config_id #1  [metadata_id: 4030]

Identity primary key.

### description / is_active #4  [metadata_id: 4033]

Whether this field grant is active. 0 = disabled, 1 = enabled (default).

### description / modified_by #8  [metadata_id: 4037]

Who last modified the field grant.

### description / modified_dttm #7  [metadata_id: 4036]

When the field grant was last modified.

## BDL_ImportLog (Table)

### category #0  [metadata_id: 3979]

Operations

### data_flow #0  [metadata_id: 3980]
...
### description #0  [metadata_id: 3977]
...
### design_note #1  [metadata_id: 3981]
...
### design_note #2  [metadata_id: 3982]
...
### design_note #3  [metadata_id: 3983]
...
### design_note #4  [metadata_id: 4074]
...
### design_note #5  [metadata_id: 4205]
...
### module #0  [metadata_id: 3978]

Tools

### query #1  [metadata_id: 4010]
...
### relationship_note #1  [metadata_id: 3984]
...
### relationship_note #2  [metadata_id: 3985]
...
### description / column_mapping #10  [metadata_id: 4000]
...
### description / completed_dttm #18  [metadata_id: 4007]
...
### description / file_registry_status #21  [metadata_id: 4196]
...
### status_value / file_registry_status #1  [metadata_id: 4206]
Title: PROCESSED
...
### status_value / file_registry_status #2  [metadata_id: 4207]
...
### status_value / file_registry_status #3  [metadata_id: 4208]
Title: FAILED
...
### status_value / file_registry_status #4  [metadata_id: 4209]
Title: CANCELED
...
### status_value / file_registry_status #5  [metadata_id: 4210]
Title: ORPHANED
...
### description / file_registry_status_code #20  [metadata_id: 4195]
...
### description / import_failed_count #27  [metadata_id: 4202]
...
### description / import_processed_count #25  [metadata_id: 4200]
...
### description / import_success_count #26  [metadata_id: 4201]
...
### description / is_complete #28  [metadata_id: 4203]
...
### description / last_polled_dttm #29  [metadata_id: 4204]
...
### description / log_id #1  [metadata_id: 3992]

Identity primary key.

### description / parent_log_ids #13  [metadata_id: 4073]
...
### description / staging_success_count #23  [metadata_id: 4198]
...
### description / staging_table #7  [metadata_id: 4141]
...
### description / started_dttm #17  [metadata_id: 4006]

When the import process was initiated by the user.

### description / status #14  [metadata_id: 4003]
...
### status_value / status #5  [metadata_id: 3990]
Title: COMPLETED
...
### status_value / status #6  [metadata_id: 3991]
Title: FAILED
...
### description / template_id #12  [metadata_id: 4001]
...
### description / total_record_count #22  [metadata_id: 4197]
...
### description / xml_filename #6  [metadata_id: 3997]
...
### category #0  [metadata_id: 4057]

Operations

### data_flow #0  [metadata_id: 4068]
...
### description #0  [metadata_id: 4055]
...
### design_note #1  [metadata_id: 4069]
...
### design_note #2  [metadata_id: 4070]
...
### module #0  [metadata_id: 4056]

Tools

### relationship_note #1  [metadata_id: 4071]
Title: BDL_ImportLog
...
### relationship_note #2  [metadata_id: 4072]
...
### description / column_mapping #5  [metadata_id: 4062]
...
### description / created_by #7  [metadata_id: 4064]
...
### description / created_dttm #8  [metadata_id: 4065]

When the template was created.

### description / description #4  [metadata_id: 4061]
...
### description / entity_type #2  [metadata_id: 4059]
...
### description / is_active #6  [metadata_id: 4063]
...
### description / modified_by #9  [metadata_id: 4066]

Who last modified the template. NULL if never modified.

### description / modified_dttm #10  [metadata_id: 4067]

When the template was last modified. NULL if never modified.

### description / template_id #1  [metadata_id: 4058]

Identity primary key.

### description / template_name #3  [metadata_id: 4060]
...
### category #0  [metadata_id: 3387]

Catalog

### data_flow #0  [metadata_id: 3478]
...
### description #0  [metadata_id: 3385]
...
### design_note #1  [metadata_id: 3479]
...
### design_note #2  [metadata_id: 3480]
...
### design_note #3  [metadata_id: 3481]
...
### design_note #4  [metadata_id: 3482]
...
### module #0  [metadata_id: 3386]

dbo

### query #1  [metadata_id: 3484]
...
### relationship_note #1  [metadata_id: 3483]
...
### description #0  [metadata_id: 3409]
...
### design_note #1  [metadata_id: 3488]
...
### design_note #2  [metadata_id: 3489]
...
### design_note #3  [metadata_id: 3490]
...
### module #0  [metadata_id: 3410]

dbo

### query #1  [metadata_id: 3493]
...
### relationship_note #1  [metadata_id: 3491]
...
### relationship_note #2  [metadata_id: 3492]
...
### description #0  [metadata_id: 3461]
...
### design_note #1  [metadata_id: 3513]
...
### design_note #2  [metadata_id: 3514]
...
### design_note #3  [metadata_id: 3515]
...
### design_note #4  [metadata_id: 3516]
...
### module #0  [metadata_id: 3462]

dbo

### query #1  [metadata_id: 3518]
...
### description / display_name #6  [metadata_id: 4024]
...
### description / element_id #1  [metadata_id: 3464]

Identity primary key.

### description / element_name #5  [metadata_id: 3467]
...
### description / field_description #18  [metadata_id: 3477]
...
### description / format_id #2  [metadata_id: 4013]
...
### description / import_guidance #19  [metadata_id: 4182]
...
### description / is_collection #9  [metadata_id: 3470]
...
### description / is_conditional_eligible #17  [metadata_id: 4194]
...
### description / is_import_required #16  [metadata_id: 4015]
...
### description / is_not_nullifiable #13  [metadata_id: 3475]
...
### description / is_primary_id #14  [metadata_id: 3476]
...
### description / is_required #8  [metadata_id: 3469]
...
### description / is_visible #15  [metadata_id: 4014]
...
### description #0  [metadata_id: 3449]
...
### design_note #1  [metadata_id: 3506]
...
### design_note #2  [metadata_id: 3507]
...
### design_note #3  [metadata_id: 3508]
...
### design_note #4  [metadata_id: 4175]
...
### module #0  [metadata_id: 3450]

dbo

### query #1  [metadata_id: 3510]
...
### relationship_note #1  [metadata_id: 3509]
Title: Catalog_BDLElementRegistry
...
### description / action_type #11  [metadata_id: 4170]
...
### status_value / action_type #1  [metadata_id: 4176]
Title: FILE_MAPPED
...
### status_value / action_type #2  [metadata_id: 4177]
Title: FIXED_VALUE
...
### status_value / action_type #3  [metadata_id: 4178]
Title: HYBRID

Reserved for future use. Combination of file-mapped and manually entered fields.

### description / batch_abbreviation #13  [metadata_id: 4172]
...
### description / entity_type #3  [metadata_id: 3454]
...
### description / folder #6  [metadata_id: 3457]
...
### description / format_id #1  [metadata_id: 3452]

Identity primary key.

### description / has_nullify_fields #9  [metadata_id: 3460]
...
### description / operational_transaction_type #14  [metadata_id: 5093]
...
### description #0  [metadata_id: 3438]
...
### design_note #1  [metadata_id: 3502]
...
### module #0  [metadata_id: 3439]

dbo

### query #1  [metadata_id: 3504]
...
### relationship_note #1  [metadata_id: 3503]
Title: Catalog_CDLFormatRegistry

Child table. Each element belongs to exactly one format entity via foreign key on spec_version + type_name.

### description / data_type #7  [metadata_id: 3445]

XSD data type with xs: prefix stripped. Common values: string, boolean, int, long, decimal, dateTime, short.

### description / display_name #6  [metadata_id: 4025]

Human-readable field name for display in the column mapping UI. Shown alongside or in place of the technical element_name to help users identify fields without needing to know DM column names. NULL values fall back to element_name display.

### description / element_id #1  [metadata_id: 3441]

Identity primary key.

### description / element_name #5  [metadata_id: 3444]

XSD element name. Corresponds to the DM database column name.

### description / format_id #2  [metadata_id: 4016]
...
### description / is_import_required #10  [metadata_id: 4018]
...
### description / is_required #8  [metadata_id: 3446]
...
### description / is_visible #9  [metadata_id: 4017]
...
### description / max_length #11  [metadata_id: 3447]

Maximum string length from XSD maxLength restriction. NULL for non-string types or when no restriction is specified.

### description / sort_order #12  [metadata_id: 3448]

Ordinal position of this element within its parent entity. 1-based.

### description / spec_version #3  [metadata_id: 3442]

XSD spec version identifier. Foreign key to Catalog_CDLFormatRegistry.

### description / type_name #4  [metadata_id: 3443]

Parent entity complexType name. Foreign key to Catalog_CDLFormatRegistry.

## Catalog_CDLFormatRegistry (Table)

### category #0  [metadata_id: 3430]

Catalog

### data_flow #0  [metadata_id: 3496]
...
### description #0  [metadata_id: 3428]
...
### design_note #1  [metadata_id: 3497]
...
### design_note #2  [metadata_id: 3498]
...
### module #0  [metadata_id: 3429]

dbo

### query #1  [metadata_id: 3500]
...
### relationship_note #1  [metadata_id: 3499]
...
### description / spec_version #2  [metadata_id: 3432]

XSD spec version identifier. No default constraint — every insert must explicitly specify.

### description / type_name #4  [metadata_id: 3434]

XSD complexType name. This is the join key to Catalog_CDLElementRegistry.

### description / xsd_filename #5  [metadata_id: 3435]

Source XSD filename within the CDL entity folder.

## EnvironmentConfig (Table)

### category #0  [metadata_id: 3936]

Operations

### data_flow #0  [metadata_id: 3937]
...
### description #0  [metadata_id: 3934]
...
### design_note #2  [metadata_id: 3939]
...
### module #0  [metadata_id: 3935]

Tools

### query #1  [metadata_id: 3957]
...
### description / config_id #1  [metadata_id: 3942]

Identity primary key.

### description / created_by #14  [metadata_id: 3954]

Who created the configuration.

### description / created_dttm #13  [metadata_id: 3953]

When the configuration was created.

### description / db_instance #5  [metadata_id: 4019]
...
### description / dmfs_base_path #7  [metadata_id: 3947]
...
### description / is_active #12  [metadata_id: 3952]

Whether this server configuration is active. 0 = disabled, 1 = enabled (default).

### description / modified_by #16  [metadata_id: 3956]

Who last modified the configuration.

### description / modified_dttm #15  [metadata_id: 3955]

When the configuration was last modified.

## parse-css.js (Script)

### category #0  [metadata_id: 5032]

Utilities

### description #0  [metadata_id: 5030]
...
### module #0  [metadata_id: 5031]

Tools

## parse-js.js (Script)

### category #0  [metadata_id: 5035]

Utilities

### description #0  [metadata_id: 5033]
...
### module #0  [metadata_id: 5034]

Tools

## Populate-AssetRegistry-CSS.ps1 (Script)

### category #0  [metadata_id: 5063]

Utilities

### description #0  [metadata_id: 5061]
...
### module #0  [metadata_id: 5062]

Tools

## Populate-AssetRegistry-HTML.ps1 (Script)

### category #0  [metadata_id: 5080]

Utilities

### description #0  [metadata_id: 5078]
...
### module #0  [metadata_id: 5079]

Tools

## Populate-AssetRegistry-JS.ps1 (Script)

### category #0  [metadata_id: 5066]

Utilities

### description #0  [metadata_id: 5064]
...
### module #0  [metadata_id: 5065]

Tools

## Populate-AssetRegistry-PS.ps1 (Script)

### category #0  [metadata_id: 5083]

Utilities

### description #0  [metadata_id: 5081]
...
### module #0  [metadata_id: 5082]

Tools

## Resolve-AssetRegistryReferences.ps1 (Script)

### category #0  [metadata_id: 5086]

Utilities

### description #0  [metadata_id: 5084]
...
### module #0  [metadata_id: 5085]

Tools

## sp_SyncColumnOrdinals (Procedure)

### category #0  [metadata_id: 3646]

Utilities

### description #0  [metadata_id: 3644]
...
### design_note #1  [metadata_id: 3650]
...
### design_note #2  [metadata_id: 3651]
...
### design_note #3  [metadata_id: 3652]
...
### module #0  [metadata_id: 3645]

Tools

### relationship_note #1  [metadata_id: 3653]
...
### description / @ObjectName #2  [metadata_id: 3648]
...
### description / @PreviewOnly #3  [metadata_id: 3649]
...
### description / @SchemaName #1  [metadata_id: 3647]
...
### category #0  [metadata_id: 5069]

Utilities

### data_flow #0  [metadata_id: 5070]
...
### description #0  [metadata_id: 5067]
...
### design_note #1  [metadata_id: 5071]
...
### design_note #2  [metadata_id: 5072]
