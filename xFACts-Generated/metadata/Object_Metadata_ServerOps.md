...
### description / sessions_with_open_tran #10

Sessions with open_transaction_count > 0

### description / sleeping_sessions #6

Sessions with status = 'sleeping'

### description / snapshot_dttm #4
...
### description / total_sessions #5

All user sessions (session_id > 50)

### description / zombie_count #8
...
### description / target_memory_mb #8

Maximum memory SQL Server can use (from max server memory)

### description / total_memory_mb #9
...
### description / signal_wait_time_ms #8
...
### description / wait_time_ms #7

Cumulative wait time in milliseconds (since service start)

### description / wait_type #5

SQL Server wait type name

### description / waiting_tasks_count #6
...
### description / buffer_cache_hit_pct #9
...
### description / ple_seconds #6

Page Life Expectancy at this snapshot

### description / server_name #2

Server this heartbeat is for

### description / snapshot_dttm #3
...
### description / correlation_target #6

Where to look for correlated activity: SELF, SECONDARY, or NULL

### description / correlation_window_min #5
...
### description / default_severity #4

Default severity level: WARNING or CRITICAL

### status_value / default_severity #1
Title: WARNING
...
### status_value / default_severity #2
Title: CRITICAL
...
### description / alert_sent #22

Whether an alert has been sent for this event

### description / alert_sent_dttm #23

When the alert was sent

### description / availability_group_name #9

Availability group name

### description / availability_replica_name #10

Replica server name

### description / collected_dttm #19

When the event was imported into xFACts

### description / current_state #8

Current state after transition

### description / database_name #11

Database name (for database-level events)

### description / ddl_action #15

DDL action performed (CREATE, ALTER, DROP)

### description / ddl_phase #16

DDL phase (START, COMMIT, ROLLBACK)

### description / ddl_statement #17

Full DDL statement text

### description / error_message #14

Full error message text

### description / error_number #12

SQL Server error number

### description / error_severity #13

Error severity level

### description / event_id #1

Unique identifier for the event

### description / event_timestamp #4

When the event occurred

### description / event_type #5

Event name from AlwaysOn_health

### description / previous_state #7

Previous state before transition

### description / raw_event_xml #18
...
### description / session_name #6

Source XE session name

### description / source_file #20

XE file the event was read from

### description / source_offset #21
...
### description / alert_sent #27

Whether an alert has been sent for this event

### description / alert_sent_dttm #28

When the alert was sent

### description / blocked_by_client_app #19

Application name from connection string

### description / blocked_by_database #17

Database context of blocking process

### description / blocked_by_host_name #20

Client machine name

### description / blocked_by_login #18

Login name of blocking process

### description / blocked_by_query_text #22

Query text of the blocking process

### description / blocked_by_spid #16

Session ID of the blocking process

### description / blocked_by_status #21

Status of blocking process (running, sleeping, suspended)

### description / blocked_client_app #10

Application name from connection string

### description / blocked_database #8

Database context of blocked process

### description / blocked_host_name #11

Client machine name

### description / blocked_login #9

Login name of blocked process

### description / blocked_query_text #15

Query text of the blocked process

### description / blocked_spid #7

Session ID of the blocked process

### description / blocked_wait_resource #14

Resource being waited on

### description / blocked_wait_time_ms #12

How long the process has been blocked (milliseconds)

### description / blocked_wait_type #13

Type of wait (e.g., LCK_M_X, LCK_M_S)

### description / collected_dttm #24
...
### description / source_file #25

XE file the event was read from

### description / source_offset #26
...
### status_value / last_collection_status #3
Title: FAILED
...
### status_value / last_collection_status #4
Title: PARTIAL
...
### description / last_file_name #5

Full path of the last .xel file processed

### description / last_file_offset #7

Byte offset at end of most recent collection

### description / modified_by #14

Who last updated the record

### description / modified_dttm #13
...
### description / alert_sent #26

Whether an alert has been sent for this event

### description / alert_sent_dttm #27

When the alert was sent

### description / collected_dttm #23

When the event was imported into xFACts

### description / deadlock_category #9
...
### description / process_count #7

Total number of processes involved in the deadlock

### description / raw_deadlock_xml #22
...
### description / source_file #24

XE file the event was read from

### description / source_offset #25

Byte offset within the source file

### description / survivor_client_app #19

Application name from connection string

### description / survivor_database #17

Database context of survivor process

### description / survivor_host_name #20

Client machine name

### description / survivor_login #18

Login name of survivor process

### description / survivor_query_text #21

Query text that completed

### description / survivor_spid #16

Session ID of the process that survived

### description / victim_client_app #13

Application name from connection string

### description / victim_count #8

Number of victims (processes killed). Values > 1 indicate complex/parallel deadlocks

### description / victim_database #11

Database context of victim process

### description / victim_host_name #14

Client machine name

### description / victim_login #12

Login name of victim process

### description / victim_query_text #15

Query text that was killed

### description / victim_spid #10
...
### description / client_app_name #7

Application name from connection string

### description / client_hostname #6

Client machine name initiating the linked server query

### description / client_pid #5

Client process ID

### description / collected_dttm #25

When the row was created or last updated

### description / database_name #8
...
### description / alert_sent #24

Whether a Teams alert was sent for this event

### description / alert_sent_dttm #25

When the alert was sent

### description / client_app_name #10

Application name from connection string

### description / client_hostname #9

Client machine name

### description / collected_dttm #21

When the event was imported to xFACts

### description / cpu_time_ms #13

CPU time consumed in milliseconds

### description / database_name #7

Database where query executed

### description / duration_ms #12
...
### description / logical_reads #14

Pages read from buffer cache

### description / physical_reads #15

Pages read from disk

### description / query_hash #19

Hash identifying query shape (ignores literals)

### description / query_plan_hash #20

Hash identifying execution plan

### description / row_count #17
...
### description / source_file #22

XE file path the event was read from

### description / source_offset #23

Byte offset in source file

### description / sql_text #18

Full query text

### description / username #8

Login that executed the query

### description / writes #16
...
### description / calling_api_name #8
...
### description / component_state #17

Component state (clean, warning, error)

### description / component_type #16
...
### description / login_time_ms #12

Total login time in milliseconds

### description / os_error #11
...
### description / session_id #6

SPID associated with the event (when applicable)

### description / signal_duration_ms #15

Signal wait portion for wait_info events

### description / source_file #19

XE file the event was read from

### description / source_offset #20

Byte offset within the source file

### description / wait_type #13
...
### description / client_app_name #9

xFACts component name from connection string ApplicationName

### description / collected_dttm #18

When the event was imported to xFACts

### description / cpu_time_ms #12
...
### description / logical_reads #13

Pages read from buffer cache

### description / physical_reads #14

Pages read from disk (typically NULL — xFACts tables stay in cache)

### description / row_count #16
...
### description / created_by #25

Who created the configuration

### description / created_dttm #24

When the configuration was created

### description / database_id #2

FK to DatabaseRegistry.database_id

### description / database_name #3

Denormalized database name for convenience

### description / diff_backup_enabled #15

Whether differential backups are scheduled

### description / diff_time #16

Time of day for diff backup (runs all days except full_day_of_week)

### description / full_backup_enabled #9

Whether full backups are scheduled

### description / full_day_of_week #11

1=Sun, 2=Mon...7=Sat (NULL if DAILY)

### description / full_frequency #10

WEEKLY or DAILY

### description / full_retention_chain_local_count #13
...
### description / full_retention_chain_network_count #14
...
### description / full_time #12

Time of day for full backup

### description / last_diff_backup_set_id #22

msdb.backupset reference for chain tracking

### description / last_diff_dttm #21

When last differential backup completed

### description / last_full_backup_set_id #20

msdb.backupset reference for chain tracking

### description / last_full_dttm #19

When last full backup completed

### description / last_log_dttm #23

When last log backup completed

### description / log_backup_enabled #17

Whether log backups are scheduled

### description / log_frequency_minutes #18

Minutes between log backups (15, 240, 1440, etc.)

### description / modified_by #27

Who last modified the configuration

### description / modified_dttm #26

When the configuration was last modified

### description / server_name #4
...
### description / bytes_processed #11

Bytes copied or uploaded

### description / completed_dttm #16
...
### description / duration_ms #10

Duration in milliseconds

### description / error_details #14
...
### description / started_dttm #15

When the operation started

### description / status #9
...
### description / aws_path #22

S3 path after successful upload

### description / aws_upload_completed_dttm #21

When AWS upload completed

### description / aws_upload_retry_count #27
...
### description / aws_upload_started_dttm #20

When AWS upload started

### description / aws_upload_status #19

PENDING, IN_PROGRESS, COMPLETED, FAILED, SKIPPED, HISTORICAL

### description / backup_finish_dttm #11

When backup completed (from msdb.backupset)

### description / backup_source #6

Source of backup: REDGATE (.sqb files) or NATIVE (.bak files)

### description / backup_start_dttm #10

When backup started (from msdb.backupset)

### description / backup_type #5

FULL, DIFF, or LOG

### description / compressed_size_bytes #9
...
### description / database_name #4

Database name

### description / file_name #7

Backup filename

### description / file_size_bytes #8

Logical/uncompressed file size from msdb.backupset

### description / local_deleted_dttm #13

When file was cleaned from local storage

### description / local_path #12

Full local path to backup file

### description / msdb_backup_set_id #23

backup_set_id from source server's msdb.backupset

### description / network_copy_completed_dttm #16

When network copy completed

### description / network_copy_retry_count #26
...
### description / network_copy_started_dttm #15

When network copy started

### description / network_copy_status #14

PENDING, IN_PROGRESS, COMPLETED, FAILED, SKIPPED, HISTORICAL

### status_value / network_copy_status,aws_upload_status #1
Title: PENDING
...
### status_value / network_copy_status,aws_upload_status #2
Title: IN_PROGRESS
...
### status_value / network_copy_status,aws_upload_status #3
Title: COMPLETED
...
### status_value / network_copy_status,aws_upload_status #4
Title: FAILED
...
### status_value / network_copy_status,aws_upload_status #5
Title: SKIPPED
...
### status_value / network_copy_status,aws_upload_status #6
Title: HISTORICAL
...
### description / network_deleted_dttm #18

When file was cleaned from network storage

### description / network_path #17

Full network path after successful copy

### description / notes #25
...
### description / allocation_errors #19
...
### description / buffer_pool_scan_seconds #26
...
### description / completed_dttm #14

When DBCC CHECKDB completed. NULL while still running.

### description / consistency_errors #20
...
### description / database_name #6

Database name as enrolled in DatabaseRegistry.

### description / dbcc_elapsed_seconds #16
...
### description / dbcc_summary_output #17
...
### description / repaired_errors #21
...
### description / split_point_lsn #24
...
### description / modified_by #24

Who last modified this schedule row.

### description / modified_dttm #23

When this schedule row was last modified.

### description / replica_override #19
...
### description / actual_value #7

Actual value when alert was created

### description / alert_details #5

Human-readable alert description

### description / alert_id #1

Unique identifier for the alert

### description / alert_key #4

Identifier within alert type (drive letter for disk)

### description / alert_method #10

How notification was sent (TEAMS, JIRA)

### status_value / alert_method #1
Title: JIRA
...
### description / alerted_dttm #9

When notification was sent

### description / detected_dttm #8

When condition was first detected

### description / is_resolved #11

Whether alert condition has cleared

### description / resolved_by #13

Who/what resolved the alert

### description / resolved_dttm #12
...
### description / drive_letter #3

Drive letter (C, D, E, etc.)

### description / free_space_mb #6

Current free space in megabytes

### description / percent_free #7
...
### description / total_size_mb #5

Total drive capacity in megabytes

### description / volume_label #4
...
### status_value / last_poll_status #2
Title: FAILED
...
### status_value / last_poll_status #3
Title: SKIPPED
...
### description / servers_monitored #6

Count of active servers in last poll

### description / status_id #1
...
### description / threshold_id #1

Unique identifier for the threshold config

### description / threshold_pct #4
...
### description / created_by #16

Who created the configuration

### description / created_dttm #15

When the configuration was created

### description / database_config_id #1
...
### description / created_by #28

Who created this schedule

### description / created_dttm #27

When this schedule was created

### description / database_id #1

FK to dbo.DatabaseRegistry.database_id

### description / day_of_week #2
...
### description / modified_by #30

Who last modified this schedule

### description / modified_dttm #29
...
### description / completed_dttm #23

When the rebuild completed (NULL if still running)

### description / database_id #5
...
### description / deferral_count_at_execution #26
...
### description / duration_seconds #20

Actual duration (NULL if still running)

### description / error_message #25

Error details if failed

### description / estimated_seconds #19

Pre-calculated duration estimate (mode-specific)

### description / fill_factor_used #17

Fill factor applied (NULL = default)

### description / fragmentation_pct_after #13

Fragmentation after rebuild (NULL if failed)

### description / fragmentation_pct_before #12

Fragmentation before rebuild

### description / index_name #10

Name of the index

### description / maxdop_used #18

MAXDOP setting used

### description / operation_type #15

REBUILD or REORGANIZE

### description / page_count #11

Page count at time of rebuild

### description / priority_score #14

Priority score at execution time

### description / queue_id #3

Original queue entry (NULL if manually triggered)

### description / rebuild_mode #16

Execution mode used: ONLINE or OFFLINE

### description / registry_id #4
...
### description / schema_name #8

Schema containing the table

### description / server_name #6

Server name from dbo.ServerRegistry

### description / started_dttm #22
...
### description / table_name #9

Table containing the index

### description / variance_pct #21
...
### description / started_dttm #6

When processing of this database started

### description / status #13
...
### description / avg_daily_fragmentation_rate #25
...
### description / current_fill_factor #12

Current fill factor setting (0 = 100%)

### description / current_fragmentation_pct #11

Last-known fragmentation from sys.dm_db_index_physical_stats

### description / current_page_count #10
...
### description / schema_name #3

Schema containing the table

### description / stats_last_updated #17
...
### description / days_since_update #14
...
### description / duration_ms #21

Duration in milliseconds

### description / error_message #23

Error details if failed

### description / max_days_stale #17

Age of oldest stat in batch

### description / min_days_stale #16

Age of youngest stat in batch

### description / modification_counter #12

Rows modified since last update (from sys.dm_db_stats_properties)

### description / pct_modified #13
...
### description / sample_pct_used #18
...
### description / started_dttm #19

When the update started

### description / stat_name #10

Name of the statistic/index (NULL for STALENESS)

### description / stats_count #15
...
### description / update_type #5

'MODIFICATION' or 'STALENESS'

### status_value / update_type #1
Title: MODIFICATION
...
### description / pending_command_count #7
...
### status_value / run_status #5
Title: 5 (Failed)

Agent has stopped due to an error.

### status_value / run_status #6
Title: 6 (Stopped)
...
### description / previous_state #5

Previous run_status code. NULL for non-state-change events

### description / previous_state_desc #6
...
### description / collected_dttm #10

When these results were captured by the collector

### description / distributor_commit_dttm #5

When the tracer token arrived at the distributor

### description / distributor_to_subscriber_ms #8
