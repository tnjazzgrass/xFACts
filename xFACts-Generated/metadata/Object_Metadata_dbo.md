...
### description / http_method #3

HTTP method (GET, POST, PUT, DELETE)

### description / request_dttm #7

When the request was processed

### description / request_id #1

Unique identifier for the log entry

### description / response_bytes #10

Size of response body in bytes

### description / source_application #11

Application that logged the request (e.g., ControlCenter)

### description / status_code #9

HTTP response status code (200, 404, 500, etc.)

### description / user_agent #6

User-Agent header - identifies browser, script, or application

### description / user_name #4
...
### description / asset_id #1

Surrogate primary key. Not stable across runs.

### description / body_hash #21
...
### description / signature #18

Construct-specific structural detail.

### description / skeleton_hash #19
...
### description / top_parent_is_active #12
...
### description / component_id #1

Auto-incrementing primary key.

### description / component_name #3
...
### description / doc_json_categories #10
...
### description / doc_section_order #13
...
### description / ModifiedDate #6

When the credential was last updated

### description / ServiceName #2
...
### description / setting_name #3

Setting identifier (must be unique within module)

### description / setting_value #4
...
### description / column_name_key #16
...
### description / created_by #13

Who created the row (auto-populated from login)

### description / created_dttm #12
...
### description / nav_id #1

Auto-incrementing primary key.

### description / nav_label #3
...
### description / section_sort_order #4
...
### description / ag_cluster_name #8

Availability Group name (NULL for standalone)

### description / api_base_url #27
...
### description / dmops_archive_enabled #21
...
### description / dmops_shell_purge_enabled #22
...
### description / fileops_enabled #19

Enable file monitoring (FileOps module)

### description / instance_name #3
...
### description / is_domain_controller #24
...
### description / jboss_ds_alert_threshold #25
...
### description / jobflow_enabled #17

Enable job monitoring (JobFlow module)

### description / last_service_start_captured_dttm #30

When the service start time was last captured

### description / last_service_start_dttm #29

SQL Server service start time from sys.dm_os_sys_info

### description / modified_by #34

Who last modified the record

### description / modified_dttm #33

When record was last modified

### description / server_id #1
