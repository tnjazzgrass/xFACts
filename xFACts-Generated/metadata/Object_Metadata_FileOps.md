...
### description / check_end_time #7

When to stop checking entirely (hard stop)

### description / check_friday #14

Check on Friday

### description / check_holidays #18

Check on holidays (future enhancement)

### description / check_monday #10

Check on Monday

### description / check_saturday #15

Check on Saturday

### description / check_start_time #6

When to begin checking for the file

### description / check_sunday #9

Check on Sunday

### description / check_thursday #13

Check on Thursday

### description / check_tuesday #11

Check on Tuesday

### description / check_wednesday #12
...
### description / config_name #3

Friendly name for this monitor (e.g., Instream Daily)

### description / create_jira_on_escalation #22
...
### description / notify_on_detection #20

Send Teams alert when file is detected

### description / notify_on_escalation #21
...
### description / event_dttm #8

Exact timestamp of the event

### description / event_type #6
...
### description / file_detected_name #7

Filename that was detected (if applicable)

### description / jira_ticket_queued #10

Whether a Jira ticket was queued for this event

### description / log_date #5
...
### description / teams_alert_queued #9
...
### description / credential_service_name #5

ServiceName in [Core - Credentials] for authentication

### description / is_enabled #6
...
### description / sftp_host #3

Hostname or IP address of the SFTP server

### description / sftp_port #4
