...
### description / alert_on_total_failure #4
...
### description / min_failure_threshold #5
...
### description / alert_on_critical_failure #12

Generate alerts if critical jobs fail within this flow

### description / alert_on_missing #11
...
### description / aggregate_completed_records #22

Total records processed across all completed jobs in this execution

### description / cancelled_job_count #20

Jobs that were cancelled

### description / completed_job_count #16

Jobs with terminal success status

### description / completion_dttm #10
...
### description / validation_dttm #11
...
### description / criticality_reason #9
...
### description / effective_end_date #11

When this configuration expires. NULL = no expiration

### description / effective_start_date #10

When this configuration becomes active

### description / has_fixed_date_logic #17

Job filter uses fixed dates (e.g., WHERE date = TODAY). Records permanently lost if missed

### description / is_business_critical #18

Job is essential for daily operations regardless of date logic

### description / is_critical #19

1 if either flag is set, 0 otherwise. Computed persisted column

### description / job_id #2

UQ

### description / job_nm #4

Full job name

### description / job_shrt_nm #3

Job short name (e.g., NBIMPORT). Denormalized

### description / last_execution_dttm #7
...
### description / alert_on_missing #12
...
### description / expected_start_time #9
...
### description / schedule_day_of_month #7

For MONTHLY: day of month (1-31)

### description / schedule_day_of_week #6

For WEEKLY: 1=Sunday through 7=Saturday

### description / schedule_frequency #5
...
### description / counter_after #5

no_progress_poll_count value after this event

### description / counter_before #4
...
### description / actual_order_nmbr #9
...
### description / expected_order_nmbr #8

Expected position in flow execution order

### description / is_critical #7

1 if this job is marked critical in JobConfig

### description / job_exctn_msg_txt #11

Error message from DM (sanitized of PII)

### description / job_id #3

Job definition ID from crs5_oltp.dbo.job

### description / job_nm #5

Full job name

### description / job_shrt_nm #4

Job short name

### description / job_stts_cd #10

DM status code if job executed

### description / notes #13

Additional context or investigation notes

### description / validation_id #2
...
### description / actual_job_count #9
...
### description / critical_jobs_failed #14

1 if any failed jobs are marked is_critical in JobConfig

### description / critical_jobs_missing #13
...
### description / missing_job_count #10

Jobs expected but not executed

### description / missing_jobs_json #15
